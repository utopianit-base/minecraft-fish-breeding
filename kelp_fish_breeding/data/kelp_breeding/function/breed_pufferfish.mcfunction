...
execute if entity @e[tag=breeding_parent,limit=2] run execute positioned as @e[tag=breeding_parent,limit=1,sort=nearest] run summon pufferfish ~ ~ ~ {Tags:["newborn"]}
