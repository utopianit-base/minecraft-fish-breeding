...
# Usage: /function fshb:config/toggle_dolphin_breeding
...
execute if score #temp fb.temp matches 0 run tellraw @s [{"text":"Dolphin breeding ","color":"green"},{"text":"enabled","color":"yellow","bold":true}]
...
execute if score #temp fb.temp matches 1 run tellraw @s [{"text":"Dolphin breeding ","color":"red"},{"text":"disabled","color":"yellow","bold":true}]
