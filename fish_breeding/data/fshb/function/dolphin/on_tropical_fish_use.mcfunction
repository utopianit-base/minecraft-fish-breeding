...
execute if entity @e[type=minecraft:dolphin,distance=..6,tag=db.in_love,limit=1] unless entity @s[gamemode=creative] run function fshb:dolphin/consume_player_tropical_fish
