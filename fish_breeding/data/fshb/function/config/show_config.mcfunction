...
execute if score #dolphins_breed fb.config matches 1 run tellraw @s [{"text":"Dolphin Breeding: ","color":"white"},{"text":"[ENABLED]","color":"green","bold":true,"underlined":true,"clickEvent":{"action":"run_command","value":"/trigger trigger.toggle_dolphins set 1"},"hoverEvent":{"action":"show_text","contents":"Click to toggle (disable)"}}]
execute if score #dolphins_breed fb.config matches 0 run tellraw @s [{"text":"Dolphin Breeding: ","color":"white"},{"text":"[DISABLED]","color":"red","bold":true,"underlined":true,"clickEvent":{"action":"run_command","value":"/trigger trigger.toggle_dolphins set 1"},"hoverEvent":{"action":"show_text","contents":"Click to toggle (enable)"}}]
